 ...
 * @param {function(string, caf.cb)} findMap A function with signature
 * `function(string, caf.cb)` to return a map in the callback. The first
...
exports.AggregateMap = function(firstMapName, findMap, linkKey) {
     ...
     *
     * @param {caf.cb} cb A callback to return a reference to the snapshot.
