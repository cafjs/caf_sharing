    ...
    that.ref = function(readOnly) {
        ...
        refThat.updatesSlice = function(firstVersion) {
            ...
            if ((refUpdates.size > 0) &&
                (refUpdates.last().version >= firstVersion) &&
                (refUpdates.first().version <= firstVersion)) {
        ...
        refThat.setFun = function(key, funString) {
            var fun;
            eval('fun = (function() { return ' + funString + ';}) ()');
            return refThat.set(key, fun);
        };
