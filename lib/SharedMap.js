...
exports.SharedMap = function(logger, noExec, maxUpdates) {
     ...
     * @return {caf.refMap} A reference to a `Shared Map` snapshot.
     *
     * @memberof! module:caf_sharing/SharedMap#
     * @alias ref
     */
    that.ref = function(readOnly) {
         ...
         *
         * @return {caf.mapUpdate} Changes to commit.
         *
         * @memberof! module:caf_sharing/SharedMap#
         * @alias caf.refMap#prepare
         */
         ...
         *
         * @return {caf.mapUpdate} A full dump of the map.
         *
         * @memberof! module:caf_sharing/SharedMap#
         * @alias caf.refMap#dump
         */
         ...
         * @param {caf.json} value A new value for `key`.
         * @return {caf.refMap} This reference for call chaining.
         * @throws Error if invalid input types.
         *
         * @memberof! module:caf_sharing/SharedMap#
         * @alias caf.refMap#set
         */
         ...
         *
         * @memberof! module:caf_sharing/SharedMap#
         * @alias caf.refMap#PASSTHROUGH_METHODS
         */
     ...
     *
     * @param {caf.mapUpdate | Array.<caf.mapUpdate>} changes Deltas to be
     * applied.
     ...
     *
     * @param {caf.refMap=} ref  An optional reference to a map snapshot. It
     ...
     *
     * @param {caf.refMap} ref A reference to the map snapshot to be
     * committed.
